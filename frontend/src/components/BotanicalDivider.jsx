...
// el cizimi tarzinda botanik ayirici.
function BotanicalDivider({ className = '' }) {
  return (
    ...
    >
      ...
      <path d="M120 20 C 110 12, 105 8, 108 3 C 112 8, 115 14, 120 20" fill="#6B7F5B" />
      <path d="M120 20 C 130 12, 135 8, 132 3 C 128 8, 125 14, 120 20" fill="#8A9C7A" />
    </svg>
  );
}
